...
function ForgotPasswordPopup(props) {
  ...
  return (
    ...
    <div className = 'password-popup' style = {OVERLAY_STYLES}>
        <div clasName = "password-popup-inner" style = {STYLES}>
            <p> Account email </p>
            <input type = "email" placeholder ='Email'></input>

            <button className = "password-popup-button" style = {CONF_BUTTON_STYLES}> Confirm </button>
            <button className = "password-popup-button" style = {CANCEL_BUTTON_STYLES} onClick = {() => props.setTrigger(false)}> Cancel </button>
